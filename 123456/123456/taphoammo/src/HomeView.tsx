          ...
          <div className="flex-1 p-6 overflow-y-auto max-h-[70vh]">
            ...
            <div className="flex items-center gap-3 mb-4 pb-4 border-b border-gray-100">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[13px] font-semibold text-gray-800">{product.seller}</span>
  ...
  return (
    <div className="min-h-screen bg-slate-100/90 font-sans">
        ...
        <div className="max-w-[2000px] mx-auto px-8 min-h-16 flex items-center justify-between gap-8">
          ...
          <div className="flex-1 max-w-2xl hidden md:flex">
            <div className="relative w-full">
              <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 text-emerald-600" size={17} />
              <input
                type="text"
                placeholder={headerT.searchPlaceholder}
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-white/40 rounded-full text-sm text-slate-800 shadow-inner focus:ring-2 focus:ring-white/60 focus:border-white focus:outline-none transition-all placeholder:text-slate-400"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3.5 flex-shrink-0">
            ...
            <button type="button" className="relative text-white hover:text-emerald-100 p-1.5 hover:bg-white/15 rounded-lg transition-colors">
              <Bell size={19} />
              <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 rounded-full text-[9px] text-white flex items-center justify-center font-bold border-2 border-white/30">3</span>
            </button>
            <button
              type="button"
              onClick={() => {
            ...
            >
              ...
              {messageThreads.length > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-300 rounded-full border-2 border-emerald-600" />
              )}
            </button>
              ...
              {userMenuOpen && (
                ...
                >
                  ...
                  <div className="py-1">
                    {(
                      [
                        { label: 'Thông tin tài khoản', onSelect: () => { setSelectedProduct(null); setStorefrontOrderDetailId(null); setStorefrontPage('account'); window.scrollTo({ top: 0, behavior: 'smooth' }); } },
                        ...(isStorefrontResellerMode
                          ? ([
                              {
            ...
            <div className="max-w-4xl mx-auto px-6 py-0">
              <div className="grid grid-cols-4 divide-x divide-slate-100">
                {[
                  ...
                  { value: '15T',   label: 'Thành viên', color: 'text-amber-600' },
          ...
          <div className="max-w-4xl mx-auto px-6 py-6 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
              <div className="px-5 py-4 border-b border-slate-100 flex items-center gap-2.5">
                ...
                <span className="text-[13px] font-bold text-slate-800">Thông tin cơ bản</span>
              </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <span className="text-[11px] text-gray-600 font-medium flex items-center gap-1 min-w-0">
                        ...
                        <span className="truncate" title={product.seller}>
                          {product.seller}
                        </span>
                        <svg className="flex-shrink-0" width="12" height="12" viewBox="0 0 24 24" fill="#3b82f6"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                      </span>
                    </div>
      ...
      <StorefrontShopHubSections
        ...
        onDangKyBanHang={onNavigateToAdmin}
      />
      ...
      <>
        <StorefrontGuestHeader
          ...
          authSlot={() => <StorefrontAuthDropdown onLoginSuccess={onStorefrontLoginSuccess} />}
        />
